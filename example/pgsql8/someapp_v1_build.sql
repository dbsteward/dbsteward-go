...
-- full database definition file generated Thu, 18 Apr 2024 11:43:15 -0400
BEGIN;
...
CREATE OR REPLACE FUNCTION public.destroy_session(IN character varying) RETURNS VOID
AS $_$
  DELETE FROM session_information WHERE session_id=$1;
$_$
LANGUAGE sql;

ALTER FUNCTION public.destroy_session(IN character varying) OWNER TO pgsql;

COMMENT ON FUNCTION public.destroy_session(IN character varying) IS 'Deletes session data from the database';
...
ALTER TABLE public.sql_user
  ADD CONSTRAINT sql_user_user_status_list_id_fkey FOREIGN KEY (user_status_list_id) REFERENCES public.user_status_list (user_status_list_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE _p_public_sql_user.partition_0
  ADD CONSTRAINT p0_user_status_list_id_fk FOREIGN KEY (user_status_list_id) REFERENCES public.user_status_list (user_status_list_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE _p_public_sql_user.partition_1
  ADD CONSTRAINT p1_user_status_list_id_fk FOREIGN KEY (user_status_list_id) REFERENCES public.user_status_list (user_status_list_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE _p_public_sql_user.partition_2
  ADD CONSTRAINT p2_user_status_list_id_fk FOREIGN KEY (user_status_list_id) REFERENCES public.user_status_list (user_status_list_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE _p_public_sql_user.partition_3
  ADD CONSTRAINT p3_user_status_list_id_fk FOREIGN KEY (user_status_list_id) REFERENCES public.user_status_list (user_status_list_id) ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE public.session_information
  ADD CONSTRAINT session_information_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.sql_user (user_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
